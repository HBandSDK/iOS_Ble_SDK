...
class VPOterFunctionSettingController: UIViewController   , UITableViewDelegate , UITableViewDataSource{
    ...
    let otherFunctions = ["同步个人信息","闹钟设置","血压私人模式设置","久坐提醒设置","心率报警设置","拍照功能","与手机配对","翻腕亮屏","修改密码","亮度调节","女性设置","倒计时功能","新闹钟设置","文字闹钟","彩屏样式设置","亮屏时长","敲击测试","照片表盘","市场表盘","手机查找手环","GPS与时区设置", "体温数据读取", "G15表盘", "G15二维码", "RR逐跳数据", "健康提醒", "联系人"]
