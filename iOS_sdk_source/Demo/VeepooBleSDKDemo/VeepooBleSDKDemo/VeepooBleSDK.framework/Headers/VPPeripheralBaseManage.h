...
/**
 ...
 @param runningMode 具体参考枚举, 如果不是多运动给0, 判断多运动的方式见VPPeripheralModel下的runningType属性说明
...
/**
 ...
 @param settingMode 设置类型, 第一次要先读取, 如果不读直接设置开或关可能会失败
 @param lowPowerResultBlock 返回结果
 */
